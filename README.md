...
#FULL CODE OF ANIMATE YOUR SITE
...
<html>
<head>
	<title>Aniamte option by Nishi IT LTD</title>
...
<body>
    <div id="your id" class=" wow fadeInDown animated" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.7s; animation-name: fadeInDown;">
</body>
</html>
```
